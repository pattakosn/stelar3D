...
int main() {
    ...
    while (!quit) {
        ...
        model = glm::rotate(model, glm::radians(ogl_app.time() * -10.0f), glm::normalize(glm::vec3(1.0, 0.0, 1.0))); // rotate the quad to show normal mapping from multiple directions
