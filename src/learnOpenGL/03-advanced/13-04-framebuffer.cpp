...
int main(int, char*[])
{
        ...
        Shader screenShader("P-1T.vert", "1T-apply.frag");
        ...
        // load textures
        texture cubeTexture("wooden_container.jpg");
        ...
        fbo.as_renderbuffer(ogl_context.screen_width(), ogl_context.screen_height());//glGenFramebuffers(1, &framebuffer);
        frame_buffer::unbind();
